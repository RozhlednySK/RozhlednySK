...
<body>
	...
	<div class="message"><b><u>Příští fotbal 30.12. výjimečně v sobotu od 10hod!!! </u></b></div>
	<br />
	...
	<br />
	<div class="message">Cena za jaro 2018: <b>700Kč</b>, jednotlivé vstupné standardně <b>50Kč</b><div>
	<br />
    <table class="att">
		<tr class="att">
...
$vysledek = mysql_query("SELECT date_format(date,'%e.%c.') as datum, holiday, comment FROM t_date order by date",$spojeni);
...
$vysledek = mysql_query("SELECT count(a.id) as pocet, a.id_date from t_player_date a, t_date b where a.id_date = b.id and a.c_att = 1 group by id_date order by id_date",$spojeni);
while ($zaznam = mysql_fetch_array($vysledek) ):
...
while ($zaznam = mysql_fetch_array($vysledek) ):
                ...
                $vysledek1 = mysql_query("SELECT a.id, a.id_date, a.c_att, a.comment FROM t_player_date a, t_date b where a.id_date = b.id and  id_player=" . $zaznam["id"] . " order by id_date", $spojeni);
